...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center tech-grid">
      ...
      <div className="absolute top-40 right-20 w-32 h-32 border border-secondary/20 rounded-lg rotate-45 float" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-40 left-20 w-16 h-16 border border-accent/20 rounded-lg float" style={{ animationDelay: '4s' }} />
